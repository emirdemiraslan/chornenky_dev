<div class="container">
    <div class="row align-items-end justify-content-between clients__wrapper clients--first">
        <div class="col-md-3 col-6 clients__client">
            <a href="#">
    ...
    <div class="row quote lightbg">
        <div class="col-sm-12 col-md-8 offset-md-2 ">
            <div class="quote__wrapper">
                <blockquote>Whether it's a big project like redesigning our corporate website, helping us rebrand our company, or helping us with last minute, critical, time sensitive projects, they always deliver!</blockquote>
                <p class="quote__title">-Corey Fong, Director of Marketing, Flashman Studios</p>
            </div>
        </div>
    </div>
